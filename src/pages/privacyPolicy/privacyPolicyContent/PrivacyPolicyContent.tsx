        ...
        <div className="privacy-policy-content">
            <div className="container">
                <div className="privacy-policy-content__wrapper">
                    <h1 className="privacy-policy-content__heading">
                        Lorem ipsum dolor sit amet
                    </h1>
                    <p className="privacy-policy-content__text">
                        ...
                        rutrum quisque non. Sit amet nulla facilisi morbi tempus
                        iaculis urna. Lorem sed risus ultricies tristique nulla
                        aliquet enim. Volutpat blandit aliquam etiam erat velit.
                        Orci eu lobortis elementum nibh. Ipsum suspendisse
                    ...
                    <p className="privacy-policy-content__text">
                        ...
                        diam. Risus in hendrerit gravida rutrum quisque non. Sit
                        amet nulla facilisi morbi tempus iaculis urna. Lorem sed
                        risus ultricies tristique nulla aliquet enim. Volutpat
                        blandit aliquam etiam erat velit. Orci eu lobortis
                        elementum nibh. Ipsum suspendisse ultrices gravida
                        dictum fusce ut placerat orci nulla. Neque convallis a
